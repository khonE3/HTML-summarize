...
```
    ...
    <h1><ins>Table</ins></h1>
    <img src="Table.png" alt="" width="300px" height="200px">
    ...
    <img src="Block and Inline.png" alt="">
    <br>
    <hr>
